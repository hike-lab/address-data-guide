---
title: 6.6 데이터 품질 평가하기
description:  병합된 데이터의 품질을 평가해보고 이를 바탕으로 활용성을 점검하는 방법을 알아봅니다.
keywords: [도로명주소,데이터오류,  품질 요소, 데이터 품질 평가, 완전성, 정확성, 이해가능성, 일관성, 유효성, 데이터정제, 공공데이터,  데이터품질, 파이썬, 정규표현식, 패턴, metric]
url: "/chapter-6/chapter-6-6.html"
---
# 6.6. 데이터 품질 평가하기

앞선 챕터에서는 공공데이터의 품질요소로 어떠한 것들이 있는지 알아봤습니다. 이번에는 실제로 어떻게 품질 요소를 평가하는 방식이 구현되는지 파이썬 코드와 함께 살펴보겠습니다. 이 장에서 사용되는 데이터와 코드 원본은 [깃헙](https://github.com/hike-lab/address-data-guide/tree/main/chapter-6/chapter6-6)에서 확인할 수 있습니다.
