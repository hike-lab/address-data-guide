...
이제 예시 데이터의 품질을 직접 평가해보도록 하겠습니다. 데이터와 원본 코드는 [깃허브]()에 있으며, [colab]() 환경에서 직접 실행시켜보실 수 있습니다.

샘플 데이터를 열면 아래 사진과 같은 파일이 열릴 것입니다.
...
여기서는 matplotlib과 seaborn 대신, 코드가 간편하고 동적인 plotly를 사용하도록 하겠습니다.
